...
print(docid)
print(userid )
fhash=getHash(UPLOAD_DIR1+filename) 
print("<html>")
print("<head>")
print("<meta http-equiv='refresh' content='0;url=http://localhost:8080/FromPythonFileHash?sts=success&userid="+userid+"&docid="+str(docid)+"&fname="+filename+"&fhash="+fhash+"'/>")
print("</head>")
print("</html>")