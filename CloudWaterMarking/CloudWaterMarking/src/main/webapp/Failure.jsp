...
<%}else if(request.getParameter("type").toString().trim().equals("RegUser"))
{
	...
	<a href="home">Home</a>
<%}
else if(request.getParameter("type").toString().trim().equals("MobileNoRepeat"))
{
	%><h2 class="h2">Mobile no already exist!!Repeat mobile no not allowed!!</h2>
	<br/>
	<a href="home">Try Again</a>
<%
}
else if(request.getParameter("type").toString().trim().equals("leakage"))
{
	%><h2>Leakage Detected!!</h2>
	<br/>
	<a href="user">Home</a>
<%
}
