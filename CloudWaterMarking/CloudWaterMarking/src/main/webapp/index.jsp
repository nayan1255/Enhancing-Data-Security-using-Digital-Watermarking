				...
				<div class="row banner-bottom-main bg-white">
						<div class="col-md-4 banner-grid2">
							<div class="banner-subg1">
								<h3 class="mt-3"><span class="fas fa-user-secret pr-3" aria-hidden="true"></span> Data Leakage Detection</h3>
							 </div>
						</div>
						<div class="col-md-4 banner-grid2">
							<div class="banner-subg1">
								<h3 class="mt-3"><span class="fas fa-user-secret pr-3" aria-hidden="true"></span> RC6 and SHA256 Algorithm for Encryption</h3>
							 	</div>
						</div>
						<div class="col-md-4 banner-grid2">
							<div class="banner-subg1">
								<h3 class="mt-3"><span class="fas fa-envelope pr-3" aria-hidden="true"></span> Secured Document Sharing</h3>
							 	</div>
						</div>
				</div>
			</div>
...
<!-- copyright -->
	<section class="copyright-w3layouts py-xl-4 py-3">
		<div class="container">
			<p>© 2023 Data Security.All Rights Reserved 
