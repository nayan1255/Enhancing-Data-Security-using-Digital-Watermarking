...
%>
	...
	<section class="w3layouts-header py-2">
        ...
        <header>
         ...
         <li class="nav-item active  mr-3"><a  class="nav-link"  href="UploadWDoc.jsp">Decrypt Documents</a></li>
       		...
       		<li class="nav-item active  mr-3"><a  class="nav-link"  href="newGroup">Groups</a> </li>
                ...
                <li class="nav-item dropdown mr-3">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="viewLeakageReport">Leakage Report</a>
