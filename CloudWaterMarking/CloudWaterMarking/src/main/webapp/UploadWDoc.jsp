...
%>
<div ><center><h2>Decrypt Documents</h2></center><br/>
 <form id="frm" action="http://localhost:80/CloudWaterMarkingPython/Wfileupload.py" method="post"  enctype="multipart/form-data">
